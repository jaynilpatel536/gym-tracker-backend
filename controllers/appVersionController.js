...
// Returns the document with the highest versionCode from all active Android records.
  ...
  try {
    ...
    if (!versionDoc) {
      return res.status(404).json({
        message: 'No app version has been published yet.',
      });
    }
...
// POST /api/app-version/android -> Admin publish or update release version metadata (protected)
